...
│   │   └── route.ts
│   ├── layout.tsx                      # Root layout (change to instruction menu na may ads)
│   └── page.tsx                        # Root landing (change to instruction menu na may ads)
...
│       └── server.ts                   # Supabase client for Server Components (di ko know if need ilagay to)

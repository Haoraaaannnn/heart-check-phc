export default function PrintFooter(){
    return(
        <div className="flex flex-col items-center justify-center bg-amber-300 w-full flex-shrink-0 px-2 sm:px-3 md:px-4 lg:px-6 portrait:lg:px-8 landscape:2xl:px-10 py-2 sm:py-3 md:py-4 lg:py-5 portrait:lg:py-6 landscape:2xl:py-8 mt-8">

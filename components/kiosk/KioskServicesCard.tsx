...
export default function ServiceCard({service}: {service: Service}){
    return(
        ...
        className="relative flex items-center h-[250px] gap-6 pl-8 pr-12 py-8 rounded-[45px] shadow-xl hover:scale-105 transition-all active:scale-95 overflow-hidden"

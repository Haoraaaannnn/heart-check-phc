  ...
  return (
    <div className="flex flex-col justify-center mb-8">
      ...
      <Link
        ...
        className="mx-8 my-3 max-w-full py-[18px] px-[18px] border-[6px] border-gray-400 font-baloo font-black text-center rounded-[45px] text-gray-400 text-[50px] transition-all active:scale-90"
      >
        Bumalik - Cancel
      </Link>
    </div>

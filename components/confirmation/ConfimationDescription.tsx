...
export default function ConfirmationDescriptions({service, descColor}: Props){
    return(
        <div className="flex flex-col items-start mx-8 mt-6 p-8 border-[2.5px] border-gray-400 rounded-[45px] bg-white shadow-sm">
            <span 
                className="inline-block text-white text-[40px] font-extrabold px-8 py-2 rounded-full mb-4"
                style={{background: descColor}}
            >

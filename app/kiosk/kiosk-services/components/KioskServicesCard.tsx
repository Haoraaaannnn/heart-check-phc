...
export default function ServiceCard({ service, patientType, onSelect }: Props) {
    ...
    return (
        <button
            ...
            className="relative flex items-center h-[164px] gap-2 pl-8 pr-12 py-6 rounded-[16px] transition-all active:scale-95 overflow-hidden bg-white border-2 border-gray-300 text-left"
        >

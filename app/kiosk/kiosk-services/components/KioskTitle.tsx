    ...
    return (
        <div className={isLandscape ? "flex h-full w-full flex-col items-center justify-center gap-4 px-4 lg:px-6" : "flex w-full flex-col items-center gap-6 px-4 lg:px-6"}>
            <div className="flex flex-col gap-4 lg:gap-6">
                ...
                <span className={isLandscape ? "text-left text-[50px] font-black text-gray-800 [-webkit-text-stroke:1px_currentColor]" : "text-[50px] font-black mt-20 my-18 text-gray-800 [-webkit-text-stroke:1px_currentColor]"}>

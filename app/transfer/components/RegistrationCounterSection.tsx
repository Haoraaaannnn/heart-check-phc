...
export function RegistrationCounterSection({
  ...
  return (
    <div className="bg-white border-2 border-blue-100 rounded-3xl shadow-sm p-5 mt-4 overflow-x-auto">
      ...
      {counters.length === 0 ? (
        <p className="text-gray-300 text-xs">No counters assigned to your account.</p>
      ) : (
        <div
          className="grid gap-3"
          style={{ gridTemplateColumns: `repeat(${counters.length}, minmax(140px, 1fr))` }}
        >
              ...
              >
                ...
                {counterPatients.map((p, i) => (
                  <div
                    ...
                    } ${i === 0 ? 'border-[#cc3535] bg-white' : 'border-gray-200 bg-white'}`}
                  ...
                  >
                    ...
                    {i === 0 && <ElapsedTimer startedAt={p.counter_top_started_at ?? undefined} />}
